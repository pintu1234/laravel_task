...
@section('content')
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <p class="panel-title"> All Employees
    ...
    <script>
        $(function () {
            table = $('#manage_all').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('getallemployees.employees') !!}',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'first_name', name: 'first_name'},
                    {data: 'last_name', name: 'last_name'},
                    {data: 'company', name: 'c_name'},
    ...
    <script type="text/javascript">
        ...
        function create() {
            ...
            $("#modal_data").empty();
            $('.modal-title').text('New Employee'); // Set Title to Bootstrap modal title
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#modalemployee').modal('show'); // show bootstrap modal
                },
        ...
        $("#manage_all").on("click", ".view", function () {
            ...
            $("#modal_data").empty();
            $('.modal-title').text('View Employee'); // Set Title to Bootstrap modal title
